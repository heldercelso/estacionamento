...
def carregar_sheet(sheet_path):
    try:
        all_sheets = openpyxl.load_workbook(sheet_path)
    except:
        all_sheets = openpyxl.Workbook()
    ws = all_sheets.active
    all_sheets.security.workbookPassword = 'djsfilho'
    all_sheets.security.lockStructure = True
    ws.protection.sheet = True
    ws.protection.enable()
    all_sheets.save(sheet_path)

    return all_sheets, all_sheets[all_sheets.sheetnames[0]]
